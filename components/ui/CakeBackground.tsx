...
const PHASES = [0, Math.PI / 2, Math.PI, (3 * Math.PI) / 2] as const
    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden isolate z-0" aria-hidden>
      ...
      <div
        className="absolute -top-[30vh] -left-[20vw] w-[90vw] h-[90vh] blur-3xl opacity-70"
          style={{ background: `radial-gradient(50% 50% at 50% 50%, ${THEME.tintA} 0%, transparent 70%)`, mixBlendMode: 'screen' }}
      />
      <div
        className="absolute -bottom-[35vh] -right-[25vw] w-[100vw] h-[100vh] blur-3xl opacity-70"
          style={{ background: `radial-gradient(50% 50% at 50% 50%, ${THEME.tintB} 0%, transparent 70%)`, mixBlendMode: 'screen' }}
      />
